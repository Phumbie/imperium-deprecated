  ...
  <div id="nav-container">
    ...
    <section class="bottom-section">
      ...
      <!-- <a
        ...
        target="_blank"
        >Blog</a -->
      <!-- <router-link to="/my-account" class="nav-item4" v-if="!userDetail"
        >Account</router-link
      >
      <router-link to="/my-account" class="nav-item4" v-else
        >Hi, {{ userDetail }}</router-link
      > -->
      <a :href="requestAuditURL" target="_blank" class="nav-item4">Buy Power</a>

      <!-- <a href="#" class="nav-item4" v-if="search" @click="showSearch">Search</a>
      <Search class="nav-item4" @toggleFocus="search = true" v-else /> -->
    </section>
    <section class="mobile-bottom-section">
      <router-link to="/my-account" class="mobile-nav-item1" v-if="!userDetail"
        >Account</router-link
      >
      <router-link to="/my-account" class="mobile-nav-item1" v-else
        >Hi, {{ userDetail }}</router-link
      >
      <!-- <router-link to="/products" class="mobile-nav-item2"
        >Buy Products</router-link
      > -->
      <a :href="requestAuditURL" class="mobile-nav-item2">Buy Power</a>
      ...
      <a href="#" class="mobile-nav-item5" v-if="search" @click="showSearch"
        >Search</a
      >
      <Search class="mobile-nav-item5" @toggleFocus="search = true" v-else />
    </section>
  </div>
</template>
